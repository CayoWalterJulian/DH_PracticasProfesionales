    ...
    <div className="bg-[#d8cfc4] p-4 min-h-screen">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {aspirantsData.map((aspirant) => (
          <Link to={`/`} key={aspirant.DNI} className="bg-white p-4 rounded-lg shadow-lg flex flex-col w-48 h-[240px] md:w-64 md:h-[310px] lg:w-72 lg:h-[320px]">
            <div className="relative bg-gray-300 h-[30%] rounded-t-lg mb-4">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <img src={aspirant.image} alt="Aspirante" className="w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 rounded-full border-4 border-white absolute bottom-[-50%] left-1/2 transform -translate-x-1/2" />
              </div>
            </div>
