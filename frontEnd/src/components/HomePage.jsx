    ...
    <div className="relative h-screen">
      ...
      <div className="relative flex flex-col items-center pt-10">
        ...
        <div className="flex flex-wrap justify-center w-full px-4 md:space-y-0 md:space-x-4 lg:space-x-4 ">
          ...
          <Link to="/postulate" className="bg-blue-950 flex flex-col items-center justify-center p-4 w-32 h-[240px] md:w-48 md:h-[280px] lg:w-72 lg:h-[400px] lg:bg-black lg:bg-opacity-50">
